-- ============================================================
-- SUPABASE: INSTRUCCIONES
-- ============================================================
-- 1. Ve a Supabase → SQL Editor → New query
-- 2. Pega TODO este archivo
-- 3. Haz clic en el botón verde "RUN" (o Ctrl+Enter)
--    ⚠️ NO uses el botón "EXPLAIN" — ese botón solo acepta
--       UNA sentencia y dará el error que viste.
-- 4. Si prefieres paso a paso, usa los archivos en:
--    database/supabase/01-crear-tablas.sql
--    database/supabase/02-datos-iniciales.sql
-- ============================================================
